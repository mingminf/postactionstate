...
class Player(QWidget):
    ...
    def __init__(self, playlist, parent=None):
        ...
        self.labelstate.setText("Image:")
        self.postactionstateimage =  QLabel()
        keyimageLayout = QHBoxLayout()
        keyimageLayout.addWidget(self.labelstate)
        keyimageLayout.addWidget(self.postactionstateimage, 1)
        ...
        layout = QVBoxLayout()
        layout.addWidget(self.videoWidget, 2)
        hLayout = QHBoxLayout()
        hLayout.addWidget(self.slider)
        hLayout.addWidget(self.labelDuration)
        layout.addLayout(hLayout)
        layout.addLayout(controlLayout)
        layout.addLayout(keyimageLayout)

        displayLayout = QHBoxLayout()
        displayLayout.addLayout(layout)
